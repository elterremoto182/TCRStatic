...
import { AlertCircle, Home, Building2, ArrowRight, Phone, MapPin, Clock, Camera, CheckCircle } from 'lucide-react';

const SERVICE_SLUG = 'emergency-restoration';

export async function generateMetadata() {
  return generatePageMetadata({
    title: truncateMetaTitle('24/7 Emergency Restoration Services | South Florida | Total Care Restoration'),
    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          {!service.images?.hero && (
            <div className="absolute inset-0 z-0 bg-gradient-to-br from-red-50 via-background to-orange-50" />
          )}
