...
export async function generateMetadata() {
  return generatePageMetadata({
    ...
    description: 'Commercial water damage restoration services throughout South Florida. Minimize business downtime with fast, professional water damage cleanup. 24/7 emergency response.',
