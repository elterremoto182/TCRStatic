...
export async function generateMetadata() {
  return generatePageMetadata({
    ...
    description: 'Professional commercial roof tarping services throughout South Florida. Emergency roof protection for businesses. Protect inventory and equipment. 24/7 response.',
    keywords: ['commercial roof tarping', 'business roof tarp', 'commercial roof protection', 'commercial storm roof'],
...
export default function CommercialRoofTarpingPage() {
  ...
  const serviceSchema = {
    ...
    description: 'Professional commercial roof tarping services for businesses throughout South Florida.',
