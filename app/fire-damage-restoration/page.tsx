...
export async function generateMetadata() {
  return generatePageMetadata({
    title: 'Fire Damage Restoration Services | South Florida | Total Care Restoration',
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {/* Hero Section */}
        <section className="pt-32 pb-20 bg-gradient-to-br from-orange-50 via-background to-red-50 relative overflow-hidden">
                ...
                {service.images.gallery.map((image, index) => (
                  ...
                  >
                    <div className="group relative aspect-[4/3] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <OptimizedImage
                        src={image}
                        alt={`Fire damage restoration work example ${index + 1}`}
                        fill
