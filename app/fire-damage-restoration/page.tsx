...
import { Flame, Home, Building2, ArrowRight, Phone, MapPin, Camera, Clock, CheckCircle } from 'lucide-react';
              ...
              <div className={`grid gap-6 ${
                ...
                {service.images.gallery.map((image, index) => (
                  <div key={index} className="group relative aspect-[4/3] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <OptimizedImage
                      src={image.src}
                      alt={image.caption || generateAltText({ type: 'gallery-item', serviceName: 'Fire Damage Restoration', index })}
                      fill
